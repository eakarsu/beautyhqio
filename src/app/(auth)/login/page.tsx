    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-50 to-pink-50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Sign in to your Beauty & Wellness AI account
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3">
            <Button
              type="button"
              variant="outline"
              className="w-full h-11 font-medium bg-black text-white hover:bg-gray-800 hover:text-white border-black"
              onClick={() => handleSocialLogin("apple")}
              disabled={socialLoading !== null}
            >
              {socialLoading === "apple" ? (
                <span className="flex items-center gap-2">
                  <span className="h-4 w-4 border-2 border-gray-300 border-t-white rounded-full animate-spin" />
                  Connecting...
                </span>
              ) : (
