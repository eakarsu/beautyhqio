...
// Gap-nonai endpoint: Public franchise / multi-tenant billing
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('public-franchise-multi-tenant-billing', body, out);
    return NextResponse.json({ feature: 'public-franchise-multi-tenant-billing', title: 'Public franchise / multi-tenant billing', result: out });
  } catch (err: any) {
