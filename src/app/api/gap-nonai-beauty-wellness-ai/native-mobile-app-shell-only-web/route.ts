...
// Gap-nonai endpoint: Native mobile app shell (only web)
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('native-mobile-app-shell-only-web', body, out);
    return NextResponse.json({ feature: 'native-mobile-app-shell-only-web', title: 'Native mobile app shell (only web)', result: out });
  } catch (err: any) {
